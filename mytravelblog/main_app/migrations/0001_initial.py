...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('travel_picture', cloudinary.models.CloudinaryField(blank=True, max_length=255, null=True, validators=[mytravelblog.common.validators.ImageSizeInMBValidator(1)], verbose_name='Travel Picture')),
            ...
            options={
                ...
                'unique_together': {('user', 'located_city', 'travel_picture')},
            },
        ),
        migrations.CreateModel(
            name='TravelEntry',
            fields=[
                ...
                ('travel_picture', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='main_app.travelpicture', verbose_name='Travel Picture')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('visited_city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.visitedcity', verbose_name='Visited City')),
                ('visited_hotel', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='main_app.visitedhotel', verbose_name='Visited Hotel')),
            ],
            options={
